...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Categoria cat6 = new Categoria(null, "Faxina");
		Categoria cat7 = new Categoria(null, "Carro");
		Categoria cat8 = new Categoria(null, "Moto");
		Categoria cat9 = new Categoria(null, "Festa");
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, dataFormatada.parse("20/10/2017 00:00"), null);
